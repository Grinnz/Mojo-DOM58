...
subtest 'Empty' => sub {
  is(Mojo::DOM58->new,                     '',    'right result');
  is(Mojo::DOM58->new(''),                 '',    'right result');
  is(Mojo::DOM58->new->parse(''),          '',    'right result');
  is(Mojo::DOM58->new->at('p'),            undef, 'no result');
  is(Mojo::DOM58->new->append_content(''), '',    'right result');
  is(Mojo::DOM58->new->all_text,           '',    'right result');
};

subtest 'Simple (basics)' => sub {
  my $dom = Mojo::DOM58->new('<div><div FOO="0" id="a">A</div><div id="b">B</div></div>');
...
subtest 'Tap into method chain' => sub {
  my $dom = Mojo::DOM58->new->parse('<div id="a">A</div><div id="b">B</div>');
...
subtest 'XML nodes' => sub {
  my $dom = Mojo::DOM58->new->xml(1)->parse('<b>test<image /></b>');
...
subtest 'Treating nodes as elements' => sub {
  my $dom = Mojo::DOM58->new('foo<b>bar</b>baz');
...
subtest 'Class and ID' => sub {
  my $dom = Mojo::DOM58->new('<div id="id" class="class">a</div>');
...
subtest 'HTML1 (single quotes, uppercase tags and whitespace in attributes)' => sub {
  my $dom = Mojo::DOM58->new(q{<DIV id = 'test' foo ='bar' class= "tset">works</DIV>});
  is $dom->at('#test')->text,       'works', 'right text';
  is $dom->at('div')->text,         'works', 'right text';
  is $dom->at('[foo="bar"]')->text, 'works', 'right text';
  is $dom->at('[foo="ba"]'), undef, 'no result';
...
subtest 'Already decoded Unicode snowman and quotes in selector' => sub {
  my $dom = Mojo::DOM58->new('<div id="snow&apos;m&quot;an">☃</div>');
...
subtest 'Replace elements' => sub {
  my $dom = Mojo::DOM58->new('<div>foo<p>lalala</p>bar</div>');
...
subtest 'Replace element content' => sub {
  ...
  $dom = Mojo::DOM58->new('<div><p id="☃" /></div>');
  $dom->at('#☃')->content('♥');
...
subtest 'Result and iterator order' => sub {
  my $dom = Mojo::DOM58->new('<a><b>1</b></a><b>2</b><b>3</b>');
  my @numbers;
...
subtest 'Attributes on multiple lines' => sub {
  my $dom = Mojo::DOM58->new("<div test=23 id='a' \n class='x' foo=bar />");
...
subtest 'Markup characters in attribute values' => sub {
  my $dom = Mojo::DOM58->new(qq{<div id="<a>" \n test='='>Test<div id='><' /></div>});
...
subtest 'Empty attributes' => sub {
  my $dom = Mojo::DOM58->new(qq{<div test="" test2='' />});
...
subtest 'Multi-line attribute' => sub {
  my $dom = Mojo::DOM58->new(qq{<div class="line1\nline2" />});
...
subtest 'Entities in attributes' => sub {
  my $dom = Mojo::DOM58->new(qq{<a href="/?foo&lt=bar"></a>});
  is $dom->at('a')->{href}, '/?foo&lt=bar', 'right attribute value';
  $dom = Mojo::DOM58->new(qq{<a href="/?f&ltoo=bar"></a>});
  is $dom->at('a')->{href}, '/?f&ltoo=bar', 'right attribute value';
  $dom = Mojo::DOM58->new(qq{<a href="/?f&lt-oo=bar"></a>});
  is $dom->at('a')->{href}, '/?f<-oo=bar', 'right attribute value';
  $dom = Mojo::DOM58->new(qq{<a href="/?foo=&lt"></a>});
  is $dom->at('a')->{href}, '/?foo=<', 'right attribute value';
  $dom = Mojo::DOM58->new(qq{<a href="/?f&lt;oo=bar"></a>});
  is $dom->at('a')->{href}, '/?f<oo=bar', 'right attribute value';
};

subtest 'Whitespaces before closing bracket' => sub {
  my $dom = Mojo::DOM58->new('<div >content</div>');
...
subtest 'Class with hyphen' => sub {
  my $dom = Mojo::DOM58->new('<div class="a">A</div><div class="a-1">A1</div>');
  my @div;
...
subtest 'Broken "br" tag' => sub {
  my $dom = Mojo::DOM58->new('<br< abc abc abc abc abc abc abc abc<p>Test</p>');
...
subtest 'Ensure XML semantics again' => sub {
  my $dom = Mojo::DOM58->new->xml(1)->parse(<<'EOF');
<table>
  <td>
    <tr><thead>foo<thead></tr>
  </td>
...
subtest 'Append and prepend content' => sub {
  my $dom = Mojo::DOM58->new('<a><b>Test<c /></b></a>');
  ...
  is $dom->all_text, 'DOMTest', 'right text';
};

subtest 'Wrap elements' => sub {
  my $dom = Mojo::DOM58->new('<a>Test</a>');
...
subtest 'Slash between attributes' => sub {
  my $dom = Mojo::DOM58->new('<input /type=checkbox / value="/a/" checked/><br/>');
...
subtest 'Dot and hash in class and id attributes' => sub {
  my $dom = Mojo::DOM58->new('<p class="a#b.c">A</p><p id="a#b.c">B</p>');
...
subtest 'Extra whitespace' => sub {
  my $dom = Mojo::DOM58->new('< span>a< /span><b >b</b><span >c</ span>');
...
subtest 'Not self-closing' => sub {
  my $dom = Mojo::DOM58->new('<div />< div ><pre />test</div >123');
...
subtest 'Huge number of attributes' => sub {
  plan skip_all => 'Regex subexpression recursion causes SIGSEGV on 5.8' unless $] >= 5.010000;
  my $dom = Mojo::DOM58->new('<div ' . ('a=b ' x 32768) . '>Test</div>');
  is $dom->at('div[a=b]')->text, 'Test', 'right text';
};

subtest 'Huge number of nested tags' => sub {
  my $huge = ('<a>' x 100) . 'works' . ('</a>' x 100);
  my $dom = Mojo::DOM58->new($huge);
...
subtest 'Namespace declaration on the same tag' => sub {
  my $dom = Mojo::DOM58->new->xml(1)->parse('<x:tag xmlns:x="ns" foo="bar" />');
  is $dom->at('ns|tag', ns => 'ns')->{foo}, 'bar', 'right result';
};

subtest 'Explicit no namespace' => sub {
  my $dom = Mojo::DOM58->new->xml(1)->parse('<foo xmlns=""><bar /></foo>');
...
subtest 'Generate tags' => sub {
  ...
  my $dom = Mojo::DOM58->new('<div>Test</div>');
